...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray earthqaukeArray = baseJsonResponse.getJSONArray("features");

            for (int i=0;i<earthqaukeArray.length();i++){
                JSONObject currentObject = earthqaukeArray.getJSONObject(i);
